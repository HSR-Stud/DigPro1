\section{Filtering in the frequency domain \buch{p.299}}
...
\subsection{The discrete Fourier transform \buch{p.220}}
...
\item Symmetry properties \buch{p.242}, see Table \ref{tab:Properties_2D_DFT} (Appendix)
\item Summary of properties \buch{p.253}, see Table ???? and ??? (Appendix)

%TODO: Tabelle  4.2, 4.3 einfügen
\end{itemize}
...
\subsection{Summary of Steps for Filtering in the Frequency Domain \buch{p.263}}
