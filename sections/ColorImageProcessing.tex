\newpage
\section{Color image processing \buch{p.399}}
\subsection{Color fundamentals \buch{p.400}}
\begin{itemize}
...
\subsection{Color models \buch{p.405}}
...
\subsubsection{RGB model \buch{p.407}}
...
\subsubsection{CMY and CMYK model \buch{p.408}}
...
\subsubsection{The HSI Color Model \buch{p.411}}
...
\subsubsection{Converting RGB $\Rightarrow$ HSI \buch{p.413}}
...
\subsubsection{Converting HSI $\Rightarrow$ RGB \buch{p.415}}
...
\subsection{Pseudocolor image processing \buch{p.420}}
\begin{itemize}
...
\subsubsection{Intensity Slicing \buch{p.420}}
...
\subsubsection{Intensity to color transformations \buch{p.423}}
\begin{minipage}{12cm}
...
\subsection{Full-Color Image Processing \buch{p.429}}
...
\subsection{Color Transformations \buch{p.430}}
...
\subsubsection{Color complements \buch{p.434}}
\begin{minipage}{12cm}
...
\subsubsection{Color slicing \buch{p.436}}
...
Similarly, any region can be used. A sphere with radius $R_0$ and center $(a_1,a_2,\dots,a_n)$ is given by
\begin{equation}
	s_i = \begin{cases}
...
% \subsection{Tone and Color Corrections \buch{p.437}}
% %TODO: How relevant is this anyway? --> not relevant, section in book got shorter
...
\subsubsection{Histogram Processing \buch{p.439}}
...
\subsection{Smoothing and sharpening \buch{p.442}}
...
\subsection{Image segmentation based on color \buch{p.445}}
...
\subsubsection{Bounding boxes \buch{p.448}}
...
\subsection{Color edge detection \buch{p.450}}
...
\subsection{Noise in color images \buch{p.452}}
