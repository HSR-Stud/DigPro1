...
\newpage
\paragraph{Unsharp Masking / Highboost \buch{p.162}}
\begin{enumerate}
...
\end{equation}
\textbf{Gradient Image:} The magnitude of the gradient, is the value of the rate of change into the direction of the gradient.
\begin{equation}
